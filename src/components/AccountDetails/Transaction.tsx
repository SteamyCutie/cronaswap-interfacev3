...
import { useAllTransactions } from 'app/states/transactions/hooks'
...
const Transaction: FC<{ hash: string }> = ({ hash }) => {
  ...
  return (
    <div className="flex flex-col w-full gap-2 px-5 py-3 rounded-md bg-gray-50 dark:bg-gray-800 transition-all">
