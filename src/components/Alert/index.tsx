    ...
    >
      ...
      <div className="flex items-center">
        ...
        <div className={!showIcon ? 'ml-0' : 'ml-3'}>
          <p className="text-sm transition-all md:text-sm text-white">{message}</p>
        </div>
      </div>
      {dismissable && (
        <div className="absolute top-2 right-2">
          <button
            ...
            className="inline-flex opacity-80 hover:opacity-100 focused:opacity-100 rounded-full p-1.5 text-gray-800 dark:text-white transition-all hover:text-gray-800/80 dark:hover:text-white/80 focus:outline-none focus:ring focus:ring-offset focus:ring-offset-purple focus:ring-purple"
          >
