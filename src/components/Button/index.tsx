...
const FILLED = {
  ...
  red: 'bg-red bg-opacity-90 w-full rounded-xl text-gray-100 hover:bg-opacity-100 disabled:bg-opacity-90',
  blue: 'bg-blue bg-opacity-90 w-full rounded-xl text-gray-100 hover:bg-opacity-100 disabled:bg-opacity-90',
  'blue-special': 'bg-blue-special bg-opacity-90 w-full text-gray-100 hover:bg-opacity-100 disabled:bg-opacity-90',
  pink: 'bg-gradient-to-r from-pink to-opaque-pink w-full rounded-xl text-gray-100 opacity-90 hover:opacity-100 disabled:bg-opacity-90',
  gray: 'rounded-xl shadow-sm focus:ring-2 focus:ring-offset-2 bg-opacity-90 w-full bg-light-border dark:bg-[#4B4B4B] text-gray-850 dark:text-gray-100 hover:bg-opacity-100 focus:ring-offset-dark-700 focus:ring-dark-900 disabled:bg-opacity-90',
  green: 'bg-green bg-opacity-90 w-full rounded-xl text-gray-100 hover:bg-opacity-100 disabled:bg-opacity-90',
  gradient:
    'w-full text-gray-100 bg-gradient-to-r from-blue to-pink opacity-100 hover:opacity-80 disabled:bg-opacity-80',
}
...
const OUTLINED = {
  ...
  gradient:
    'border border-transparent border border-gradient-r-blue-pink-gray-100 dark:border-gradient-r-blue-pink-gray-850 opacity-100 hover:opacity-60 disabled:bg-opacity-20 text-blue transition-all',
}
...
const LINK = {
  default: 'text-primary hover:text-gray-100 focus:text-gray-100 whitespace-nowrap focus:ring-0',
