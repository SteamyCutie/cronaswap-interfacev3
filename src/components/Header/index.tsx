...
const AppBar = (): JSX.Element => {
  ...
  return (
    <header className="flex-shrink-0 w-full">
      <Popover as="nav" className="z-10 w-full bg-white dark:bg-gray-800 transition-all">
        {({ open }) => (
          <>
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="fill-gray-800 dark:fill-white transition-all">
                    <svg width="180" height="34" viewBox="0 0 180 34" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <stop offset="0.512485" stop-color="#FFEB17" />
                        ...
                        >
                          ...
                          <stop offset="0.380035" stop-color="#FF0058" />
