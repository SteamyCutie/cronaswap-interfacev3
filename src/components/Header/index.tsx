...
const AppBar = (): JSX.Element => {
  ...
  return (
    <header className="flex-shrink-0 w-full">
      <Popover as="nav" className="z-10 w-full py-6 px-4 md:p-0 bg-white/90 dark:bg-gray-800/90 text-gray-800 dark:text-gray-50 shadow-lg transition-all font-extrabold">
        {({ open }) => (
          <>
