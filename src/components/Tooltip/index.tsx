...
export default function Tooltip({ text, ...rest }: TooltipProps) {
  return (
    <Popover
      content={
        <div className="w-full max-w-[228px] px-4 py-2 font-medium bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-850 rounded shadow-lg text-sm">
          {text}
        </div>
      }
      {...rest}
