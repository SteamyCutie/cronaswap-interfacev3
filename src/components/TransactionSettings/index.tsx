...
import { useSetUserSlippageTolerance, useUserSlippageTolerance, useUserTransactionTTL } from 'app/states/user/hooks'
      ...
      <div className="grid gap-2">
        ...
        <div className="flex items-center justify-between gap-2">
          <div
            ...
            tabIndex={-1}
          >
            <div className="flex items-center justify-between gap-1 transition-all text-gray-800 dark:text-white">
              {tooLow || tooHigh ? (
      ...
      <div className="grid gap-2">
        ...
        <div className="flex items-center">
          ...
          >
            <input
              className={classNames(
                deadlineError ? 'text-red' : 'text-gray-800 dark:text-white',
            ...
            />
            <Typography variant="xs" className="text-base transition-all text-gray-800 dark:text-white">
              {i18n._(t`minutes`)}
            </Typography>
          </div>
        </div>
