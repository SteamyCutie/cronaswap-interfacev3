...
import { injected } from '../../configs/wallets'
  ...
  if (account) {
    return (
      <div
        ...
        className="flex items-center px-3 py-2 m-0.5 text-sm rounded-xl bg-gray-100 dark:bg-gray-850 transition-all text-gray-800/80 dark:text-gray-50/80"
