        ...
        <div>
          <Disclosure.Button
            className={classNames(
              index ? 'rounded-b' : '',
              'w-full z-0 px-4 py-6 text-left cursor-pointer select-none bg-white hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-850 text-gray-800 dark:text-primary text-sm md:text-lg border border-gray-100 dark:border-gray-800 transition-all'
            )}
          >
            <div className="flex gap-x-2">
              ...
              <div className="flex items-center w-1/2 col-span-2 space-x-4 lg:gap-5 lg:w-3/12 lg:col-span-1">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  {farm?.isCommunity && (
                    <span className="inline-flex items-center px-3 py-0.5 font-bold dark:font-normal ml-0 mr-auto text-xs transition-all rounded-full text-pink/80 dark:text-yellow bg-gray-850/10 dark:bg-gray-50/5 text-gray">
              ...
              <div className="flex flex-col justify-center w-2/12 space-y-1">
                <div className="text-xs md:text-[14px] opacity-80">{i18n._(t`Earned`)}</div>
              ...
              <div className="flex-col justify-center hidden space-y-1 lg:w-2/12 lg:block">
                <div className="text-xs md:text-[14px] opacity-80">{i18n._(t`Liquidity`)}</div>
                <div className="text-xs font-bold md:text-base">{formatNumber(farm.tvl, true)}</div>
              </div>

              {/* Multiplier */}
              <div className="flex-col justify-center hidden space-y-1 lg:w-2/12 lg:block">
                {/* <div className="text-xs md:text-base opacity-80">{i18n._(t`Multiplier`)}</div> */}
                <div className="flex items-center text-xs md:text-[14px] opacity-80">
                  {i18n._(t`Multiplier`)}
              ...
              {farm.chef === 0 ? (
                <div className="flex flex-col justify-center w-2/12 space-y-1 lg:w-1/12">
                  <div className="text-xs md:text-[14px] opacity-80">APR</div>
                ...
                //   <div className="text-xs md:text-base opacity-80">vAPR</div>
              ...
              {farm.chef === 1 ? (
                <div className="flex-col justify-center w-2/12 space-y-1 lg:w-2/12">
                  ...
                  <div className="md:flex">
                    {/* <div className="text-xs font-bold md:text-base">{formatPercent(farm.apr)} / </div> */}
                    <div className="flex items-center">
                      <LockClosedIcon className="h-4 mr-1 text-yellow" />
                      {/* <div className="text-xs font-bold md:text-base">{formatPercent(farm.apr*1.01)} → {formatPercent(farm.boostApr)}</div> */}
