...
import { useBlockNumber } from 'app/states/application/hooks'
import { useSingleCallResult, useSingleContractMultipleMethods } from 'app/states/multicall/hooks'
import { useCallback, useEffect, useMemo, useState } from 'react'
import SMART_CHEF_ABI from 'app/constants/abis/smartChef.json'
import { parseUnits } from '@ethersproject/units'

export function useUserInfo(pool: any, token: any) {
